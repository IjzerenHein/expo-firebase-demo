...
export function getFirebaseOptionsFromAndroidGoogleServicesFile(googleServicesJson) {
...
export function getFirebaseOptionsFromAndroidManifest() {
    const { manifest } = Constants;
    if (!manifest)
        throw new CodedError('ERR_MANIFEST', 'Manifest not available');
...
export function getFirebaseOptionsFromManifest() {
